...
public interface ItemRepository extends JpaRepository<Item, Long> {
	...
	// @Query(value = "select i from Item i where fts( i.name, :string) AND
	// fts(i.brand, :string) = true", nativeQuery = true)
	// public Optional<List<Item>> fullTextItemSearchs(@Param("string") String
	// string);
